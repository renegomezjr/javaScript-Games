...
function getTrainingEventMessage() {
  const myEvent = getRandomEvent();
  document.getElementById('trainingDayResults').innerHTML = ('Your event is a ' + myEvent + '. Your event activities consist of ' + getEventActivities(myEvent) + '. You have ' + getDaysToTrain(myEvent) +  ' days to train.');
}
